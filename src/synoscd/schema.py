...
class AppSpec(BaseModel):
    ...
    environment: Optional[List[EnvVar]] = Field(default=None, description="Environment variables")
    ingress: Optional[IngressConfig] = Field(default=None, description="Ingress settings")
    scale: Optional[ScaleConfig] = Field(default=None, description="Scale settings")
    secrets: Optional[Dict[str, str]] = Field(default=None, description="Secret references (key vault)")
    suspend: bool = Field(default=False, description="Suspend reconciliation for this app")
...
class AppStatus(BaseModel):
    ...
    last_synced_from_commit: Optional[str] = Field(default=None, alias="lastSyncedFromCommit")
...
class AppMetadata(BaseModel):
    ...
    namespace: Optional[str] = Field(default="default", description="Logical namespace (for multi-tenancy)")
    labels: Optional[Dict[str, str]] = Field(default=None, description="Labels for filtering/grouping")
    annotations: Optional[Dict[str, str]] = Field(default=None, description="Annotations for metadata")
...
class ProjectSpec(BaseModel):
    ...
    apps: List[str] = Field(default_factory=list, description="App names in this project")
    defaults: Optional[Dict[str, Any]] = Field(default=None, description="Default spec fields for all apps")
    policy: Optional[Dict[str, Any]] = Field(default=None, description="Policy constraints (e.g., allowed registries)")
